...
import com.example.a79875.todaynews.adapter.EmojiGridViewAdapter;
import com.example.a79875.todaynews.widegt.ExpandGridView;
...
public class EmojiHelper {
    ...
    public EmojiHelper(int type, Context mContext, EditText et_input) {
        ...
        this.type = type;
        this.emojiResList = EmojiUtil.getResList(type);
        getPagers();
    }
    ...
    public View getGridView(int position) {
        ...
        View containerView = View.inflate(mContext, R.layout.grid_view, null);
...
//        }
        ...
        final EmojiGridViewAdapter mEmoJiAdapter = new EmojiGridViewAdapter(type, mContext, position, mEmoJiList);
        ...
        eg_gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int positionIndex, long id) {
                ...
                if (!fileName.equals("[删除]")) { // 不是删除键，显示表情
                    showEmoJi(fileName);
                } else { // 删除文字或者表情
                    deleteContent();
                }
    ...
    private void showEmoJi(String fileName) {
        ...
        et_input_container.setText(EmojiUtil.parseEmoJi(type, mContext, stringBuilder.toString()));
            ...
            if (selectionStart > 0) {
                ...
                if (lastStr.equals("]")) {//表情
                    ...
                    if (i != -1) {
                        ...
                        if (EmojiUtil.getAllRes().contains(tempStr)) {//校验是否是表情
